...
public class RLogical implements RAtomicInterface{
	Vector<String> data;
	...
	public P getP(int i, TableLayoutDOCX tf, String fontColor) {
		...
		Text text = new Text();
		PPr parProperties = tf.getLogicalPar();
		RPr textProperties = XmlUtils.deepCopy(tf.getLogicalText());
	...
	public CTTextBody getP(int i, org.lysis.reporters.tables.TableLayoutPPTX tf,
		...
		CTRegularTextRun textRun = org.lysis.reporters.pptx4r.elements.Utils.getRun(data.get(i));
		CTTextCharacterProperties chartext = XmlUtils.deepCopy(tf.getLogicalText());
	...
	public String getHTML(int i, org.lysis.reporters.tables.TableLayoutHTML tf) {
		String out = "";
		out += "<p class=\"LogicalPar\"><span class=\"LogicalText\">";
		out += data.get(i);
		out += "</span></p>";
		return out;
	}
	...
	public String getHTML(int i, String fontColor, org.lysis.reporters.tables.TableLayoutHTML tf) {
		...
		String out = "";
		out += "<p class=\"LogicalPar\"><span class=\"LogicalText\" style=\"color:" + fontColor + ";\">";
		out += data.get(i);
		out += "</span></p>";
		return out;
	}	
